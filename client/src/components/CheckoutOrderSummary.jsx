...
const CheckoutOrderSummary = () => {
  ...
  const colorMode = mode('gray.700', 'gray.400');
  ...
  return (
    <Stack spacing='8' rounded='xl' padding='8' width='full'>
      ...
      <Stack spacing='6'>
        ...
        <Flex justify='space-between'>
          <Text fontSize='lg' fontWeight='medium' color={colorMode}>
            Total
          </Text>
          <Text fontWeight='medium' color={colorMode}>
            ${Number(total())}
      ...
      />
      <Box align='center'>
        <Text fontSize='sm'>Have any questions? Or need help to complete your order?</Text>
